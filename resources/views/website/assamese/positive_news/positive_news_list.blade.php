...
<div class="positive-news">
                    	...
                    	@if(count($latest_tow_positive_assamese_news) > 0)
	                        ...
	                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	                            <ul class="blog-image-gap">
	                                <li>
	                                    <h3><a href="{{ route('positive_news_detail', ['positive_news_id' => encrypt($item->id) ]) }}">{{ $item->heading }}</a></h3>
    ...
    <div class="like-section container">
        <h3 style="margin:0;padding: 6px 14px; margin-bottom: 10px; width: 20%;background: #eaea4c;text-align: center;">শহতীয়া খবৰ</h3>
