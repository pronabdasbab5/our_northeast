...
<head>
    ...
    <meta property="og:url" content="{{ route('left_center_right_news_detail', ['left_center_right_news_id' => encrypt($assamese_lcr_news_single_record[0]->id) ]) }}" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="{{ $assamese_lcr_news_single_record[0]->heading }}" />
    <meta property="og:description" content="{{ $assamese_lcr_news_single_record[0]->short_desc }}" />
    <meta property="og:image" content="{{ asset('assets/big_img/'.$assamese_lcr_news_single_record[0]->image.'') }}" />
</head>
            ...
            <div class="row">
                <div class="col-md-12">
                    <center>
                        ...
                        <p class="positive-news-text" style="margin-top: -20px; width: 500px;">যিখন পৃথিৱীত পক্ষপাতদুষ্ট খবৰো নিৰপেক্ষ বা স্বতন্ত্ৰ বক্তব্য হিচাপে প্ৰচাৰ কৰা হয় ; আমি বাতৰিবোৰ ভিন্ন দৃষ্টিভংগীৰ পৰা প্ৰচাৰ কৰিবলৈ চেষ্টা কৰিম আৰু পাঠক, দৰ্শকক তথ্যগত মত গঢ়ি তুলিবলৈ সুবিধা প্ৰদান কৰিম।</p>
                    </center>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="single-image">
                        <img src="{{ asset('assets/big_img/'.$assamese_lcr_news_single_record[0]->image.'') }}" alt="Blog single photo">
                    </div>
                    <h3><a href="{{ route('left_center_right_news_detail', ['left_center_right_news_id' => encrypt($assamese_lcr_news_single_record[0]->id) ]) }}">{{ $assamese_lcr_news_single_record[0]->heading }}</a></h3>
                     <span class="author"><a href="#"><i class="fa fa-user-o" aria-hidden="true"></i> {{ $assamese_lcr_news_single_record[0]->author }}</a></span>
                    <span class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> {{ Carbon\Carbon::parse($assamese_lcr_news_single_record[0]->created_at)->format('M d Y') }}</span>
                    <span class="like"><a href="#"><i class="fa fa-comment-o" aria-hidden="true"></i>  {{ $assamese_lcr_news_single_record[0]->time }} </a></span>
                    <div style="display: inline-flex;" class="pull-right">
                        <div class="share-btn" style="padding-right: 8px;"><a rel="noopener noreferrer" onclick="ga('send', 'event', { eventCategory: 'whatsappStory', eventAction: 'click', eventLabel: 'sharebutton'});" target="_blank" title="share on whatsapp" class="whatsapp-desktop" href="https://web.whatsapp.com/send?text={{ route('left_center_right_news_detail', ['left_center_right_news_id' => encrypt($assamese_lcr_news_single_record[0]->id) ]) }}" data-text="{{ route('left_center_right_news_detail', ['left_center_right_news_id' => encrypt($assamese_lcr_news_single_record[0]->heading) ]) }}" data-href="{{ route('left_center_right_news_detail', ['left_center_right_news_id' => encrypt($assamese_lcr_news_single_record[0]->id) ]) }}"><button class="share-button whatsapp"><i class="fa fa-whatsapp">  Share</i></button></a></div>
                        <div class="share-btn" style="padding-right: 8px;"><iframe id="twitter-widget-1" scrolling="no" frameborder="0" allowtransparency="true" class="twitter-share-button twitter-share-button-rendered twitter-tweet-button" style="position: static; visibility: visible; width: 60px; height: 20px;" title="Twitter Tweet Button" src="https://platform.twitter.com/widgets/tweet_button.0639d67d95b7680840758b6833f06d87.en.html#dnt=false&amp;id=twitter-widget-1&amp;lang=en&amp;original_referer=https%3A%2F%2Fdeveloper.twitter.com%2Fen%2Fdocs%2Ftwitter-for-websites%2Ftweet-button%2Foverview.html&amp;size=m&amp;text=Guides%20%E2%80%94%20Twitter%20Developers&amp;time=1566304093898&amp;type=share&amp;url={{ route('left_center_right_news_detail', ['left_center_right_news_id' => encrypt($assamese_lcr_news_single_record[0]->id) ]) }}"></iframe></div>
                        <div class="share-btn"><a href="https://www.facebook.com/sharer/sharer.php?u={{ route('left_center_right_news_detail', ['left_center_right_news_id' => encrypt($assamese_lcr_news_single_record[0]->id) ]) }}&amp;src=sdkpreparse"><img src="{{ asset('web/content/fb.jpg') }}" width="65"></div>
                    </div>
                    <p>
                    	{!! $assamese_lcr_news_single_record[0]->long_desc !!}
                    </p>
                    <div class="admin">
                        <div class="col-md-3">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <div class="sidebar-area">
                        <div class="recent-post-area hot-news">
                            ...
                            <ul class="news-post">
                            	@if(count($assamese_lcr_latest_three_records) > 0)
                            		@foreach($assamese_lcr_latest_three_records as $key => $item)
		                                <li>
		                                    <div class="row">
