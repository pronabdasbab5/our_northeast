        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">  
                    <div class="row">
                    	@if(count($latest_tow_assamese_lcr_news) > 0)
                        	@foreach($latest_tow_assamese_lcr_news as $key => $item)
	                            ...
	                            <ul class="blog-image-gap">
	                                <li>
	                                    ...
	                                    <div class="blog-image">
	                                        <a href="{{ route('left_center_right_news_detail', ['left_center_right_news_id' => encrypt($item->id) ]) }}">
                    ...
                    <div class="hot-news">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                @if(count($all_assamese_lcr_news) > 0)
                                    @foreach($all_assamese_lcr_news as $key => $item)
                                    <li>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-8 content">
                                                ...
                                                <span class="date"><i class="fa fa-calendar-check-o" aria-hidden="true"></i> {{ Carbon\Carbon::parse($item->created_at)->format('M d Y') }}</span>
                                                <span class="duration" style="padding-left: 10px;"><i class="fa fa-clock-o" aria-hidden="true"></i> {{ $item->time }} </span>
                                                <br><br><a style="padding-top: 20px<br><a style="padding-top: 20px; color: red<br><a style="padding-top: 20px; color: blue;" href="{{ route('left_center_right_news_detail', ['left_center_right_news_id' => encrypt($item->id) ]) }}">READ MORE...</a>
                                            </div>
                                        </div>
                                    </li>
                                	@endforeach
