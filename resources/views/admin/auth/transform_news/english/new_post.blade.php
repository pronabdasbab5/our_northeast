  ...
  <div class="clearfix"></div>
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Transform English News Post</h2>
            <div class="clearfix"></div>
            <center>
                @if(session()->has('msg'))
                    <b>{{ session()->get('msg') }}</b>
          ...
          <div class="x_content"><br />
                <form method="POST" action="{{ route('english_transform_add_news_post', ['top_category_id' => $top_category_id]) }}" autocomplete="off" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
