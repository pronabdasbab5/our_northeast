      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content"><br />
            ...
            <form method="POST" autocomplete="off" action="{{ route('add_ascategory', ['tcategoryId' => $atcategoryData->id]) }}" class="form-horizontal form-label-left">
                @csrf

              <div class="form-group">
                <label class="control-label col-md-2 col-sm-2 col-xs-12">Top-Category Name : <span class="required">*</span></label>
                <div class="col-md-8 col-sm-8 col-xs-12">
                  <input type="text" name="atcategory_name" value="{{ $atcategoryData->top_category }}" class="form-control col-md-7 col-xs-12 text-bold" placeholder="Top-Category Name" disabled readonly>
