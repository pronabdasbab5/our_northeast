      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content"><br />
                <form method="POST" action="{{ route('update_assamese_news', ['newsId' => $news[0]->id]) }}" autocomplete="off" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
...
$(document).ready(function(){
    $('#top_category').change(function(){
        ...
        $.ajax({
            url: "{{ url('retrive_sub_category/') }}/"+category_id,
            method: "POST",
