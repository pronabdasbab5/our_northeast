      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content"><br />
                <form method="POST" action="{{ route('assamese_add_news_post') }}" autocomplete="off" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                        ...
                        <div class="form-row mb-10">
                            <div class="col-md-4 col-sm-12 col-xs-12 mb-3">
                                ...
                                <select class="form-control" name="top_category" id="top_category">
                                    ...
                                    @if(isset($allAtcategory))
                                        @foreach($allAtcategory as $allc)
